...
<body>
	...
	숫자 3자리마다 쉼표 제거 : <fmt:formatNumber value="${number }" type="number" groupingUsed="false" />	<%-- groupingUsed는 기본 값이 true임 --%>
	<br>
	...
	3.14(0.####) : <fmt:formatNumber value="3.14" pattern="#.####" />	<br>
	3.141592(0.####) : <fmt:formatNumber value="3.141592" pattern="#.######" />	<br>
